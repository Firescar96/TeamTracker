...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    //managedObjectModel_ = [NSManagedObjectModel mergedModelFromBundles:[[NSArray alloc] initWithObjects:[NSBundle mainBundle], nil]];
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TeamTracker" withExtension:@"momd"];
